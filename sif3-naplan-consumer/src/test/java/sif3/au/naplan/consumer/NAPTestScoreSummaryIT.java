...
public class NAPTestScoreSummaryIT {
    ...
    public void testConsumer() {
        try {
            ...
            Assert.assertTrue("Response body contains NAPTestScoreSummarys", NAPStudentResponseSetCollectionType.class.cast(responses.get(0).getDataObject()).getNAPStudentResponseSet().size() > 0);
        } catch (Exception ex) {
